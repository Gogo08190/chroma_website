...
class AssetServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        /* CSS */
        Asset::add('theme_uikit_css', 'https://cdn.jsdelivr.net/npm/uikit@3.10.1/dist/css/uikit.min.css', [], $theme->getHeader('version'))->to('front');
        Asset::add('theme_custom_css', 'css/custom.min.css', [], $theme->getHeader('version'))->to('front');

        /* JS */
        Asset::add('theme_uikit_js', 'https://cdn.jsdelivr.net/npm/uikit@3.10.1/dist/js/uikit.min.js', [], $theme->getHeader('version'))->to('front');
